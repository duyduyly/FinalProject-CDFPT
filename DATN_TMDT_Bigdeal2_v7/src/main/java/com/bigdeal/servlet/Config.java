...
public class Config {
	...
	public static String vnp_Returnurl = "https://9fb2101dfe31.ngrok.io/vnpay-response";
	public static String vnp_TmnCode = "UDOPNWS1";
	public static String vnp_HashSecret = "EBAHADUGCOEWYXCMYZRMTMLSHGKNRPBN";
	...
	public static String Sha256(String message) {
		String digest = null;
		try {
			MessageDigest md = MessageDigest.getInstance("SHA-256");//Nó thường dùng để khởi tạo một class mà không cần dùng đến cú pháp new Foo()
			byte[] hash = md.digest(message.getBytes("UTF-8"));
